...
public class SDBlockEntities
{
	...
	public static void init()
	{
		...
		HALF_DRAWER = Registry.register(Registry.BLOCK_ENTITY_TYPE,
				...
				BlockEntityType.Builder.create(BlockEntityHalfDrawer::new, SDBlocks.HALF_OAK_DRAWER, SDBlocks.HALF_BIRCH_DRAWER, SDBlocks.HALF_ACACIA_DRAWER, SDBlocks.HALF_DARK_OAK_DRAWER, SDBlocks.HALF_SPRUCE_DRAWER, SDBlocks.HALF_JUNGLE_DRAWER, SDBlocks.HALF_CRIMSON_DRAWER, SDBlocks.HALF_WARPED_DRAWER).build(null));
